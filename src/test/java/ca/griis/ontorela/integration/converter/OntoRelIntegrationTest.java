 ...
 * @since 2018-09-06
 */
public class OntoRelIntegrationTest {
  // **************************************************************************
  ...
  public static void initDataSet() {
    d.titre("Test " + OntoRelIntegrationTest.class.getName());
  ...
  @Test
  public void testGetDatabase() throws OntorelCreationException, OWLOntologyCreationException {
    for (File jdd : ConstructeurJdd.creationJddParRepo(repo)) {
  ...
  @Test
  public void testGetOntology() throws OntorelCreationException, OWLOntologyCreationException {
    for (File jdd : ConstructeurJdd.creationJddParRepo(repo)) {
  ...
  @Test
  public void testCreateDomainSet() throws OntorelCreationException, OWLOntologyCreationException {
    for (File jdd : ConstructeurJdd.creationJddParRepo(repo)) {
  ...
  // Opérations propres
  //
  private OntoRel getOntoRel(File jdd)
      throws OntorelCreationException, OWLOntologyCreationException {
